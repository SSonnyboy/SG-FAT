...
from torchattacks import FGSM, MIFGSM, BIM, PGD, APGD, Square
from autoattack import AutoAttack

from models import ResNet18, MyPreActResNet18
from utils.dataset import test_transform, TinyImageNet200
...
def main(method, gpu, ifAA):
    test_loader = DataLoader(
        TinyImageNet200("/home/chenyu/ADV/data", train=False, transform=test_transform),
        batch_size=100,
        shuffle=False,
        num_workers=4,
    )
