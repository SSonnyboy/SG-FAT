from core_cifar10 import cifar10_run
...
parser.add_argument("--ls", type=float, default=0.6)
...
cifar10_run(seed=seed, device=gpu, name=name, alpha=alpha, T=T, label_smoothing=ls, mode=mode)